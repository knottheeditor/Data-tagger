...
VISION_BURST_PROMPT = (
    ...
    "COUNTING PEOPLE — COUNT CAREFULLY:\n"
    "- Count the number of DISTINCT women by looking for separate bodies, different skin tones, or different positions.\n"
    "- Reflections in mirrors or shiny surfaces are NOT a separate person.\n"
    "- If you see 1 woman, say 'Solo'. If 2, say 'Duo'. If 3+, say 'Trio' or 'Group'.\n"
    "- When in doubt, count the number of distinct pairs of hands or distinct torsos visible.\n\n"
    "DO NOT HALLUCINATE — STRICT RULES:\n"
    "- ONLY describe what you can PHYSICALLY SEE in the frames. Do NOT guess or assume.\n"
    ...
    "- If you are unsure what act is happening, say 'masturbation' or 'teasing' — never guess a more extreme act.\n\n"
    "RULES:\n"
...
SYNTHESIS_PROMPT_TEMPLATE = (
    ...
    "- If most segments say 'Solo', the final description MUST say solo — do not upgrade to duo/trio.\n\n"
    "GOOD examples:\n"
